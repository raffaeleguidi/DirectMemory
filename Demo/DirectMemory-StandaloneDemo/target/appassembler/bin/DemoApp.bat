...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="DemoApp" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" org.directmemory.demo.App %CMD_LINE_ARGS%
